...
User.create(username: 'DTrump', name: 'Donald Trump', email: 'dt@example.com', password: '123', avatar: 'https://cdn.cnn.com/cnnnext/dam/assets/221109104540-donald-trump-florida-221108-large-169.jpg', bio: 'ur fired', birthday: '6-14-46', location: 'USA')
